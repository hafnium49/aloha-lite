...
4. **Add your API key**: Replace `your-google-cloud-api-key-here` with your actual Google Cloud API key
...
- `fields` (dict): Dictionary mapping field names to values
...
- `fields` (dict): Dictionary mapping field names to new values
...
- `filename` (str): Name for the audio file
- `language` (str, optional): Language code (default: "cmn-cn" for Chinese)
